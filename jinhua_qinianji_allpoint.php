...
$sql_er = 'SELECT id, er_name, SUM(zhi_jinhua) FROM test002 GROUP BY er_name ORDER BY id ASC';
...
for ($i = 0; $i < count($rrr['series'][0]['data']); $i++){
    $sql_san = "SELECT id, san_name, SUM(zhi_jinhua) FROM test002 WHERE er_name ='".$rrr['series'][0]['data'][$i]['name']."' GROUP BY san_name ORDER BY id ASC";
...
for ($i = 0; $i < count($rrr['series'][1]['data']); $i++){
    $sql_si = "SELECT id, si_name, SUM(zhi_jinhua) FROM test002 WHERE san_name ='".$rrr['series'][1]['data'][$i]['name']."' GROUP BY si_name ORDER BY id ASC";
